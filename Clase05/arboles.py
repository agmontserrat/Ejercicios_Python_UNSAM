#Este es el ejercicio arboles.py de la clase 4. Lo vamos a modificar un poco
import csv
import pprint
...
# Ejercicio 4.18: En el ejercicio anterior usaste una sola linea para seleccionar las alturas de los Jacarandás en parques porteños.
